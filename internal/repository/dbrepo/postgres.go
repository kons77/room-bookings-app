...
// !!!! Merge the AllNewReservations and AllReservations functions into a single function with a boolean parameter to control whether all or only new reservations are retrieved.
